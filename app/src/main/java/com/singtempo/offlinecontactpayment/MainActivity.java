...
public class MainActivity extends Activity {
    ...
    @Override public void onCreate(Bundle b) {
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            @Override public boolean shouldOverrideUrlLoading(WebView v, String u) { return handle(Uri.parse(u)); }
            boolean handle(Uri u) {
    ...
    @Override protected void onActivityResult(int r, int c, Intent d) {
        ...
        if (r == FILE_CHOOSER && fileCallback != null) {
            Uri[] x = null;
            if (c == RESULT_OK && d != null && d.getData() != null) x = new Uri[]{d.getData()};
            fileCallback.onReceiveValue(x);
            fileCallback = null;
        }
    }

    public class AndroidBridge {
        @JavascriptInterface public void saveExcel(String base64, String filename) {
            try {
                ...
                if (Build.VERSION.SDK_INT >= 29) {
                    ...
                    if (u == null) throw new Exception("Could not create Downloads file");
                    try (OutputStream o = getContentResolver().openOutputStream(u)) {
                        if (o == null) throw new Exception("Could not open Downloads file");
                        o.write(bytes);
                    }
                    ...
                    try (OutputStream o = new FileOutputStream(new File(dir, filename))) { o.write(bytes); }
                }
                runOnUiThread(() -> Toast.makeText(MainActivity.this, "Excel saved to Downloads", Toast.LENGTH_LONG).show());
            } catch (Exception e) {
